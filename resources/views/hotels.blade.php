	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/cover-img-4.jpg); height:500px;">
...
<form class="" action="/voyages/storage" method="post">
	@csrf
	<div class="form-group">
		<label for="libelle">Libellé</label>
		<input type="text" name="libelle" class="" placeholder="Entrez libellé">
	</div>
  <div class="form-group">
    <label for="pays">Pays</label>
    <input type="text" name="pays" class="" placeholder="Entrez pays">
  </div>
	<div class="form-group">
		<label for="ville">Ville</label>
		<input type="text" name="ville" class="" placeholder="Entrez ville">
	</div>
	<div class="form-group">
		<label for="date_debut">Date de début</label>
		<input type="date" name="date_debut" class="" placeholder="Entrez date">
	</div>
	<div class="form-group">
		<label for="date_fin">Date de fin</label>
		<input type="date" name="date_fin" class="" placeholder="Entrez date">
	</div>
	<div class="form-group">
		<label for="cout">Coût</label>
		<input type="number" name="cout" class="" placeholder="Entrez cout">
	</div>
	<div class="form-group">
		<label for="libelle">Photo</label>
		<input type="text" name="photo" class="" placeholder="Entrez libellé">
	</div>
	<div class="form-group">
		<label for="description">Description</label>
		<textarea name="description" rows="2" cols="50">Entrez une description</textarea>
	</div>
	<div class="form-group">
		<label for="disponibilite">Disponibilité</label>
		<select class="" name="disponibilite">
			<option value=""></option>
